...
lbl3 = tk.Label(frame, text="UserLog", width=30, fg="black",
                bg="light slate grey", height=2, font=('times', 13, ' bold  '), borderwidth=3, relief="groove")
...
def TrackImages():
    ...
    if (koruk == 6):
        mixer.init()
        mixer.music.load("F:\Songs\ENGLISH\Immigrant.mp3")
        mixer.music.play()
        res = "UNKNOWN person found"
        message2.configure(text=res)
...
trackImg = tk.Button(frame, text="Track Images", command=TrackImages, fg="black",
                     bg="light slate grey", width=45, height=1, activebackground="azure", font=('times', 13, ' bold '), borderwidth=3, relief="groove")
